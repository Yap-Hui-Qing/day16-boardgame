...
# run the application
ENTRYPOINT SERVER_PORT=${PORT} java -jar target/day16-boardgame-0.0.1-SNAPSHOT.jar
...
COPY --from=builder /app/target/day16-boardgame-0.0.1-SNAPSHOT.jar vttpb-ssf-day16-boardgame.jar
...
ENTRYPOINT SERVER_PORT=${PORT} java -jar vttpb-ssf-day16-boardgame.jar